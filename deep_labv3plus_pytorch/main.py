...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--data_root", type=str, default='/media/ubuntu/4T/ALISURE/Data/SS/voc', help="path")
    parser.add_argument("--dataset", type=str, default='voc', choices=['voc', 'cityscapes'], help='dataset name')
    ...
    parser.add_argument("--lr_policy", type=str, default='poly', choices=['poly', 'step'], help="lr scheduler")
    ...
    parser.add_argument("--vis_num_samples", type=int, default=8, help='number of samples for vis (default: 8)')
    return parser
...
"""
python main.py --crop_val --ckpt checkpoints/best_deeplabv3plus_mobilenet_voc_os16.pth --test_only --save_val_results
"""
