...
"""
 background: 82.333%	  aeroplane: 49.603%
    bicycle: 34.899%	       bird: 56.364%
       boat: 30.997%	     bottle: 50.957%
        bus: 60.309%	        car: 62.759%
        cat: 64.366%	      chair: 27.332%
        cow: 63.862%	diningtable: 53.169%
        dog: 63.137%	      horse: 63.839%
  motorbike: 71.082%	     person: 60.475%
pottedplant: 39.684%	      sheep: 74.361%
       sofa: 54.066%	      train: 54.156%
  tvmonitor: 45.776%	
======================================================
       mIoU: 55.406%
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='/mnt/4T/Data/data/SS/voc/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt', type=str)
    parser.add_argument("--predict_dir", default='../../../ZOther/SEAM/pred', type=str)
    parser.add_argument("--gt_dir", default='/mnt/4T/Data/data/SS/voc/VOCdevkit/VOC2012/SegmentationClass', type=str)
    parser.add_argument('--logfile', default='./evallog.txt',type=str)
    parser.add_argument('--comment', default="one", type=str)
