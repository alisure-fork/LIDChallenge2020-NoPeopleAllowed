...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_list", default="./ImageSets/Segmentation/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="./ImageSets/Segmentation/val.txt", type=str)
    parser.add_argument("--session_name", default="resnet38_SEAM", type=str)
    parser.add_argument("--crop_size", default=448, type=int)
    parser.add_argument("--weights", default="./SEAM_model/ilsvrc-cls_rna-a1_cls1000_ep-0001.params", type=str)
    parser.add_argument("--voc12_root", default='/mnt/4T/Data/data/SS/voc/VOCdevkit/VOC2012', type=str)
    parser.add_argument("--tblog_dir", default='../../../SEAM/tblog', type=str)
