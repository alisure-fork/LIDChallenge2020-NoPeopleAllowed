...
class CAMRunner(object):
    ...
    def __init__(self, config):
        ...
        self.dataset_mlc_train, self.dataset_mlc_val = DatasetUtil.get_dataset_by_type(
            DatasetUtil.dataset_type_mlc_no_person, image_size=self.config.mlc_size,
...
class Config(object):
    ...
    def __init__(self):
        ...
        self.mlc_model_dir = "../../../WSS_Model_No_Person/{}".format(self.model_name)
